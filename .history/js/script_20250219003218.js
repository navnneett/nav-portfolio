document.addEventListener("DOMContentLoaded", function () {
    ...
    const aboutLink = document.querySelector('.nav-links li a[href="#about"]');
    const projectsLink = document.querySelector('.nav-links li a[href="#projects"]');
    
    // Ensure the element exists before applying the class
    if (aboutLink) {
        if (window.location.pathname.includes("about")) {
            aboutLink.classList.add('active-about'); // Add the active class for the About link
        } else {
            aboutLink.classList.remove('active-about'); // Remove active class for other pages
        }
    } else {
        console.log("About link not found.");
    }

    // Ensure the Projects link is handled similarly
    if (projectsLink) {
        if (window.location.pathname.includes("projects")) {
            projectsLink.classList.add('active-projects'); // Add active class for Projects link
        } else {
            projectsLink.classList.remove('active-projects'); // Remove active class for other pages
        }
    } else {
