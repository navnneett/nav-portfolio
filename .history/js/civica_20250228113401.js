...
let currentIndex = 0;  // Default index for the carousel
let flickityInstance = null;  // Store the Flickity instance
...
function changeCategory(category) {
    ...
    // Reinitialize Flickity for the newly shown carousel
    if (flickityInstance) {
        flickityInstance.destroy();  // Destroy the old instance to avoid conflicts
    }

    flickityInstance = new Flickity(selectedCarousel.querySelector('.carousel'), {
        wrapAround: true,     // Enables infinite scrolling
        autoPlay: 3000,       // Autoplay every 3 seconds
        pageDots: true,       // Enable dots below the carousel
