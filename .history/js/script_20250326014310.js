...
function triggerMagic() {
    ...
    if (bunnyImg && magicButton) {
        ...
        bunnyImg.src = '/img/landing-page/magic-bunny.gif'; 

        // Hide the button after the first click
        magicButton.style.display = 'none';

        // Preload the second GIF
        const magicGif = new Image();
        magicGif.src = '/img/landing-page/magic-bunny.gif';  // Load magic GIF
        
        // Only show the button after the magic GIF is loaded
        magicGif.onload = function() {
            // After the GIF has loaded, revert back to bunny and show the button again
            setTimeout(function() {
                bunnyImg.src = '/img/landing-page/initial-bunny.gif'; // Revert to the bunny image
                magicButton.style.display = 'block'; // Show the button again
            }, 14000); // Revert after 3 seconds
        };
