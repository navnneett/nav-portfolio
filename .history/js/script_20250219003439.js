...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (projectsLink) {
        // Check if we are on the landing page (index.html)
        if (window.location.pathname === "/index.html" || window.location.pathname === "/") {
            // Remove the active class for About on the landing page to prevent underline
            projectsLink.classList.remove('active-about');
            console.log("On the landing page, removing 'active-about' class from About link");
        } else {
            // Add the active class for other pages to show underline on the Projects link
            projectsLink.classList.add('active-about');
            console.log("On another page, adding 'active-about' class to About link");
        }
    } else {
