...
let currentDressImage = "../img/game/dress1.png"; // Default dress image
...
function checkAnswer(questionNumber, selectedAnswer) {
    ...
    if (selectedAnswer === correctAnswers[questionNumber - 1]) {
        ...
        currentDressImage = `../img/game/dress${questionNumber + 1}.png`;  // Update dress image
...
function resetGame() {
    ...
    currentDressImage = "../img/game/dress1.png"; // Reset to initial dress image
}
