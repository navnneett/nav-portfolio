...
function resetGamePosition() {
    ...
    gameLandingContent.style.position = "absolute"; // Reset any absolute positioning that may have been changed
    gameLandingContent.style.top = "auto";  // Reset position
    gameLandingContent.style.left = "auto"; // Reset position
}
