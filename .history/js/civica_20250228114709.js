...
function changeCategory(category) {
    ...
    const carouselContainers = document.querySelectorAll('.ux-carousel-container');
...
function generateDots(category) {
    const carouselImages = document.querySelectorAll(`#${category}-carousel .ux-carousel-img`);
    const dotsContainer = document.querySelector(`#${category}-carousel .ux-carousel-dots`);
...
function showSlide(index) {
    const carouselImages = document.querySelectorAll(`#${currentCategory}-carousel .ux-carousel-img`);
